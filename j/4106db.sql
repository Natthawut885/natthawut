...
-- Database: `4106db`
--
CREATE DATABASE IF NOT EXISTS `4106db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `4106db`;
...
(1, 'นัธวุฒิ บัวงาม', 'admin1', '$2y$10$V/ZC2hiMpFq2wouF.5olEuWsDCS9J5bBuWBmXx7Fd/fKve7JRUzUe'),
(2, 'เมธาวาลัย พรมน้อย', 'admin2', '$2y$10$pf/EEfyjd7PzIBSILh3gpe8cAMSzckm8lCYr0AIDchJchwPojiXxi');
