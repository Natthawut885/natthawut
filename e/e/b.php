...
<div class="container my-5">
    ...
    if (isset($_POST['Submit'])){
	   ...
	   mysqli_query($conn, "SET NAMES utf8");
	    ...
	    $sql = "insert into application (an_id, an_position, an_title, an_fullname, an_dop, an_education, an_skills, an_experience) VALUES (null,'{$position}','{$title}','{$fullname}','{$dob}','{$education}','{$skills}','{$experien}');";
